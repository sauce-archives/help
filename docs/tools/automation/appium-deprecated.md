---
title: Appium (Deprecated Usage)
layout: en
permalink: docs/testing-tools/automation/appium-deprecated/
---


PLEASE NOTE: This page describes an old version. We recommend making use of our <a href="/docs/testing-tools/automation/appium">improved Appium support</a>.
...
<h5>testobject_appium_version</h5>
